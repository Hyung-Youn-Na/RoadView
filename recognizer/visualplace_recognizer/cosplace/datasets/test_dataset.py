...
class InferDataset(data.Dataset):
    def __init__(self, dataset_folder, query_img_path):
        """Dataset with images from database and queries, used for validation and test.
        Parameters
        ----------
        dataset_folder : str, should contain the path to the val or test set,
        ...
        if not os.path.exists(query_img_path):
            raise FileNotFoundError(f"Folder {query_img_path} does not exist")
        ...
        self.queries_paths = [query_img_path]
...
class RawDataset(data.Dataset):
    ...
    def __repr__(self):
        return (f"< {self.dataset_name} - #Dataset: {self.dataset_num} >")
...
class QueryDataset(data.Dataset):
    def __init__(self, query_img_path):
        """Dataset with images from database and queries, used for validation and test.
        Parameters
        ----------
        dataset_folder : str, should contain the path to the val or test set,
    ...
    def __repr__(self):
        return f"< {self.dataset_name} - #q: {self.queries_num} >"
