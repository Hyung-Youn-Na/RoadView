...
from detector.object_detection.yolov7.yolo_utils.google_utils import gsutil_getsize
from detector.object_detection.yolov7.yolo_utils.metrics import fitness
from detector.object_detection.yolov7.yolo_utils.torch_utils import init_torch_seeds
