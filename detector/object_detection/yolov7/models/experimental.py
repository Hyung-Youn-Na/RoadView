...
from detector.object_detection.yolov7.models.common import Conv
from detector.object_detection.yolov7.yolo_utils.google_utils import attempt_download
...
class End2End(nn.Module):
    '''export onnx or trt model with NMS operation.'''
